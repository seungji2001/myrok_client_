...
export const summary: Summary[] = [
  {
    summaryId: 1,
    summary:
      '김도연은 축제 팟, 송지은은 코드리뷰 사이트, 백승지와 이가연은 협업툴을 제안했습니다.\n 필수 구현 사항으로는 소셜 로그인과 Spring Security, 그리고 웹소켓을 활용한 실시간 채팅이 있으며, AI 음성 채팅 에디터를 추가로 구현하고자 합니다.\n 서비스의 주요 기획 틀은 팀 생성, 프로젝트 관리, 일정 관리, 회의록 생성과 회의 요약, 그리고 AI를 활용한 회의 내용 요약 등이 포함됩니다.\n',
  },
  {
    summaryId: 2,
    summary:
      '송지은은 파일 서버 용량 관리와 보안을 강조하며, 동시 편집을 강조하고 팀장만 편집 가능한 권한을 부여하는 등 협업에 필요한 기능을 제안했습니다.\n 이가연은 회원가입/로그인, 실시간 채팅, 알림 등의 기능을 요구했습니다.\n 백승지는 대시보드 구성에 대해 재고려이 필요하다고 지적했고, 김도연은 협업툴 관련 사례 분석과 필수 기능을 중심으로 설명했습니다.\n 요약하면, 각 팀원은 주요 기능과 협업 도구에 대한 요구사항을 제시하며, 협업 툴의 핵심 기능과 사용자 경험을 강화하는 것이 중요하다고 강조했습니다.\n',
  },
  {
    summaryId: 3,
    summary:
      '송지은은 파일 서버 용량 관리와 보안, 회의록 동시 편집 기능 등을 중요하게 여깁니다.\n이가연은 회원가입/로그인, 실시간 채팅, 알림 등을 요구합니다.\n김도연은 협업툴 관련 사례 분석과 필수 기능을 중점으로 설명합니다.\n백승지는 AI 챗봇과 동시 편집, 프로젝트 관리 등을 담당합니다.\n역할 분담은 김도연(백엔드), 백승지(팀장/백엔드), 송지은(프론트), 이가연(백엔드)으로 구성됩니다.\n',
  },
  {
    summaryId: 4,
  ...
  },
  {
    summaryId: 5,
    summary:
      '피그마 디자인에 대한 피드백을 받고 있으며, 팀 생성 시 최소 1명에서 최대 10명까지 인원을 제한하며, 팀원 목록을 볼 수 있고, 회의록을 생성하고 조회할 수 있습니다.\n 텍스트 편집기나 마크다운을 통해 회의록을 작성하며, 작성자만 수정 및 삭제 버튼이 확인 가능합니다.\n',
  },
  {
    summaryId: 6,
    summary:
      '프론트: 송지은은 로그인 API 및 프로젝트 생성/참가 API 구현 중이며, 다음 주에는 로그인과 프로젝트 관련 기능에 중점을 두고 UI 마크업을 완료할 예정입니다.\n 백엔드: 백승지는 프로젝트 생성/참가 및 에러 코드 작업을 완료했고, 다음 주에는 코드 수정과 챗봇 기능에 집중할 계획입니다.\n 이가연은 회의록 및 태그 관련 작업을 완료하고, 다음 주에는 모든 회의록 조회와 필터링 조회에 집중할 예정입니다.\n 김도연은 소셜 로그인 API 명세서 작성을 완료하고, 다음 주에는 소셜 로그인 코드를 완성하고 테스트 코드를 작성할 예정입니다.\n 마지막으로, 백엔드 팀은 코드 리뷰 및 문서화에 중점을 두고 협업할 예정입니다.\n',
  },
  {
    summaryId: 7,
    summary:
      '프론트: 송지은은 프로젝트 참가 관련 작업을 진행 중이며, 다음 주에는 프로젝트 내부 페이지 UI를 마무리하고 회의록 관련 기능을 구현할 예정입니다.\n 백엔드: 백승지는 프로젝트 생성과 참가 관련 로직을 완료했으며, 다음 주에는 open AI를 마무리할 계획입니다.\n 이가연은 예외 처리 및 회의록 조회 기능을 구현 중이며, 김도연은 소셜 로그인 코드 수정을 진행 중입니다.\n 또한, 대시보드의 태그 그래프 업데이트에 대한 제안이 있습니다.\n',
  },
  {
    summaryId: 8,
    summary:
      '송지은은 프론트 엔드 완료, openAI 연동은 진행 중.\n 백승지는 백엔드 작업을 완료했고, 보안 및 권한 설정까지 완료.\n 소셜 로그인 API 작업은 진행 중이며, 다음 주에 오류 수정 예정.\n 그래프 업데이트를 위해 crontab 사용 및 주기적 업데이트 방안을 고려 중.\n',
  },
  {
    summaryId: 11,
    summary:
